-- =========================================================================
-- INGESTA MEJORADA: PRESERVACIÓN DE TODAS LAS FILAS DE VENTA (ERP / POS MULTI-LINE)
-- =========================================================================
...
BEGIN
  ...
  SELECT
    ...
    ROW_NUMBER() OVER (
      PARTITION BY 
        x.transaccion, x.anio, x.mes, x.dia, x.fecha, x.vendedor, x.tercero_aux,
